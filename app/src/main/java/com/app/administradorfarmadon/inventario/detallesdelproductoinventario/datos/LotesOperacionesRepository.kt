...
class LotesOperacionesRepository(
    ...
    suspend fun corregirVencimientoLote(clienteId: String, productId: String, lote: com.app.administradorfarmadon.inventario.compartido.modelo.LoteProducto, nuevoVencimiento: String, motivo: String, usuarioEmail: String) = bloqueo.corregirVencimientoLote(clienteId, productId, lote, nuevoVencimiento, motivo, usuarioEmail)
